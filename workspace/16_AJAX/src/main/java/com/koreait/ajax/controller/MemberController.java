...
public class MemberController {
	...
	@PostMapping(value="insertMember.do", produces="application/json; charset=utf-8")
	@ResponseBody
	...
	public Map<String, Object> selectMemberList(@RequestBody Page page,
												 Model model) {
		model.addAttribute("page", page.getPage());		// page.getPage() => 정수값을 꺼내서 넘겨줘야 한다. 
		return selectMemberListCommand.execute(sqlSession, model);
	}
	
	@PostMapping(value="selectMemberByNo.do", produces="application/json; charset=utf-8")
	@ResponseBody
