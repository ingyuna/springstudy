...
public class MyController6 {
	...
	/*
		...
		1. HttpServletRequest request -> 장점) request에서 파라미터뿐만 아니라 session도 꺼낼 수 있기 때문에 여전히 중요하다.
		2. @RequestParam
		3. DTO
		4. @ModelAttribute
	...
	*/
	...
	public String a(HttpServletRequest request, 	// 현재 request에 name, age 파라미터
					Model model) {		
	...
	// defaultValue="0" : 파라미터가 없으면 0을 사용한다. -> 기본값
